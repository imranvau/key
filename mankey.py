...
class Terkey:
  ...
  def banner(self):
      ...
      print(f'{a}By Imran vau'.center(53))
      print("".join([i for i in "\n"*3]))
      
  # Loading animation   
  def animate(self,params):
    self.banner()
    print(f"{c}Imran vau Setting up keys..")
  ...
  def about(self):
    ...
    This is Termux Key !
    A program from {a}Imran vau{c} for you.
    This tool is only for Termux app and absolutely FREE for imran vau!
